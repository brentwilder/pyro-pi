...
def log_humid_temp_data(sleep_time, n_points, data_dir, filename):
    ...
    time, RH, T = logSensorData(n_points, sleep_time)
...
def log_pyranometer_data(sleep_time, n_points, data_dir, filename):
    ...
    while i_point < n_points:
        ...
        data = [time_out, serial0, offset0, multiplier0, p0_out, serial1, offset1, multiplier1, p1_out]
...
if __name__ == '__main__':
    ...
    Store every minute locally to be unloaded in the office later.
    '''
    ...
    # When disconnected the program stops.
    i = 0
    while i < 1:
